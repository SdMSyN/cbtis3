...
?>
		...
		<div class="row">
			<div class="col-sm-12">
				<form class="form-signin" method="POST" id="formFicha">
					...
					<input type="text" id="inputFicha" name="inputFicha" class="form-control" placeholder="TLXEMS16/######" >
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#formFicha').validate({
				rules: {
					inputFicha: {required: true, regx: /^T{1}L{1}X{1}E{1}M{1}S{1}1{1}6{1}\/{1}\d{6}$/ }
				},
				messages: {
					inputFicha:{ 
