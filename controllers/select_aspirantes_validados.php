<?php
    ...
    if($_GET['action'] == 'listar'){
        $sqlGetUsers = "SELECT id, Nombre, Ap, Am, Curp, Ficha, validacion_ficha, ficha_interna, documentacion, aula_exam FROM $tAsp WHERE validacion_ficha=1 ";
        //$datos=array();
        //
        // Ordenar por
		$name = $_POST['nombre'];
        ...
        while($rowGetUser = $resGetUsers->fetch_assoc()){
            ...
            $datos .= '<td>'.$rowGetUser['aula_exam'].'</td>';
            ...
            else if($rowGetUser['validacion_ficha'] == 1 && $rowGetUser['documentacion'] == NULL) 
